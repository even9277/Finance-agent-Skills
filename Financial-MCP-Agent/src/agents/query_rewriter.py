...
from src.prompts.query_rewrite import (
    FALLBACK_REWRITER_SYSTEM_PROMPT as _FALLBACK_REWRITER_SYSTEM_PROMPT,
    SOP_REWRITER_SYSTEM_PROMPT as _SOP_REWRITER_SYSTEM_PROMPT,
    TUSHARE_REWRITER_REFINER_PROMPT as _TUSHARE_REWRITER_REFINER_PROMPT,
    TUSHARE_REWRITER_SYSTEM_PROMPT as _TUSHARE_REWRITER_SYSTEM_PROMPT,
)
