...
class SkillRouterTests(unittest.TestCase):
    def test_routes_finance_question_to_tushare(self):
        ...
        self.assertEqual(result.selected_skill, "tushare-data")
        self.assertGreaterEqual(result.confidence, 0.8)
        self.assertEqual(result.analysis_mode, "single_stock_fundamental")
    ...
    def test_follow_up_inherits_prior_finance_context(self):
        ...
        self.assertEqual(result.selected_skill, "tushare-data")
        self.assertEqual(result.analysis_mode, "stock_selection")
